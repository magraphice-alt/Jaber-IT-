                        ...
                        <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                          {t.recipientMobile && (
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-xs font-mono font-black text-slate-900">{t.recipientMobile}</span>
                            </div>
                          )}
                          {t.adminPin && (
                        ...
                        <div className="mt-1">
                          {t.isResent ? (
                            <span
                              ...
                              className="text-[10px] bg-slate-100 border border-slate-300 text-slate-500 font-bold px-1.5 py-0.5 rounded flex items-center gap-1 cursor-not-allowed shadow-2xs inline-flex"
                            >
                            ...
                            <button
                              ...
                              className="text-[10px] bg-gradient-to-r from-rose-600 to-amber-600 hover:from-rose-500 hover:to-amber-500 text-white font-black px-2 py-0.5 rounded flex items-center gap-1 cursor-pointer transition-all shadow-2xs active:scale-95 inline-flex"
                            >
